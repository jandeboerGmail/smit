...
#stadgenoot
    ...
    path('zOrderStadgenootContact',views.zOrderStadgenootContact,name='zOrderStadgenootContact'),
...
#Berkhout
    ...
    path('zOrderBerkhoutContact',views.zOrderBerkhoutContact,name='zOrderBerkhoutContact'),
...
#Smit
    ...
    path('zOrderSmitContact',views.zOrderSmitContact,name='zOrderSmitContact'),
